...
public class AdGydeTrackerPlugin extends CordovaPlugin {
    ...
    public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) {
        ...
        if(action.equals("setPhoneNumber") && args.length() == 1){

            return setPhoneNumber(optString(args, 0));
        }

        if(action.equals("setEmailId") && args.length() == 1){

            return setEmailId(optString(args, 0));
        }
    ...
    public void onPause(boolean multitasking) {
        AdGyde.callOnResume((Activity) context);
    ...
    public void onDestroy() {
        AdGyde.callOnDestroy((Activity) context);
    }
    ...
    private boolean initAdGyde(final String appKey, final String channel) {
        ...
        AdGyde.callOnCreate((Activity) context);
    ...
    private boolean removeCurrentScreen(final String screenName) {
        ...
        AdGyde.removeCurrentScreen(context,screenName);
